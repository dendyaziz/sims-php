...
<form method="POST" action="">	
		...
		<div class="row">
			<div class="col-md-12">
				<div class="form-group">
					...
					<input type="text" class="form-control" id="jenis" name="jenis" value="<?php if(!empty($jenis)){echo $jenis;}?>" required="required">
				</div>
			</div>
		</div>
	...
	<div class="modal-footer">
		<button type="submit" class="btn btn-primary btn-sm" formaction="fc/fc_edit_category_modal.php"><i class="fa fa-refresh"></i> Update</button>
