...
-->
		<?php		
			...
			*/
			...
			$file="Inventory_Report.xls";
			
			if(!empty($_POST['branch'])){$branch=$_POST["branch"];}else{if(!empty($_GET["branch"])){$branch=$_GET["branch"];}else{$branch=$_SESSION["pratama"]["branch"];}}
