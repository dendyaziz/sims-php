...
<body>
    <page size="A4" layout="landscape">
		...
		<table width="100%" cellspacing="0" cellpadding="5">
			<tr>
				<td><b>OUTGOING REPORT</b><br><?php echo "Period ".date('d/m/Y',strtotime($awal))." s/d ".date('d/m/Y',strtotime($akhir));?><br><?php echo "Location ".$branch;?></td>
			</tr>
		</table>
...
<?php
$halaman="outgoing-report.php?faktur=$faktur&branch=$branch&awal=$awal&akhir=$akhir&kode_customer=$kode_customer&jenis=$jenis&kode=$kode&salesman=$salesman&tipe_outgoing=$tipe_outgoing";
?>
