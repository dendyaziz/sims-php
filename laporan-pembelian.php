...
<body class="fix-header card-no-border fix-sidebar">
		...
		<div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h3 class="text-themecolor">Laporan Pembelian</h3>
                        <ol class="breadcrumb">
							...
							<div class="col-sm-12 col-xs-12">
								...
								<div class="table-responsive" id="cetak">
									<div class="Sembunyikan">
										<h5 class="card-title"><b>LAPORAN PEMBELIAN</b>				
									...
									<table class="table table-sm table-hover table-bordered" id="table">
										...
										<tbody>
											...
											if($branch=="All Branch"){
												$sql="Select * from PEMBELIAN where tanggal between '$pAwal' and '$pAkhir' order by tanggal, suplier, faktur, jenis, barang, satuan, kode";
											}else{
												$sql="Select * from PEMBELIAN where branch='$branch' and (tanggal between '$pAwal' and '$pAkhir') order by tanggal, suplier, faktur, jenis, barang, satuan, kode";
											}
	...
	<script language="javascript">
		function printContent(el){
			...
			document.location.href='laporan-pembelian.php?branch=' + a + '&awal=' + b + '&akhir='+ c;
		}
	</script>
</body>
</html>
