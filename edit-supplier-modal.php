...
<form method="POST" action="">	
	<div class="modal-header">
		<h4 class="modal-title" id="editModalLabel">Edit Supplier</h4>
	...
	<div class="modal-body">
		...
		<div class="form-group">
			...
			<input type="text" class="form-control" id="supplier" name="supplier" value="<?php if(!empty($supplier)){echo $supplier;}?>" required="required">
		</div>
		<div class="form-group">
	...
	<div class="modal-footer">
		<button type="submit" class="btn btn-primary btn-sm" formaction="fc/fc_edit_supplier_modal.php"><i class="fa fa-refresh"></i> Update</button>
