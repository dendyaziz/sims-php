...
if(!empty($_POST["id"])){	
	...
	if(isset($_FILES['img'])){		
		...
		if(in_array($file_ext,$extensions)=== false){
			...
			header("location: ../edit-user.php?id=$id&info=Gagal, $errors");
			...
			if(empty($errors)==true){
				...
				header("location: ../edit-user.php?id=$id&info=Gambar profil User sudah berhasil diganti.");		
			}
		}		
	}else{
		header("location: ../edit-user.php?id=$id&info=Hai, sepertinya ada yang salah nih, mohon ulangi kembali.");
	}	
}else{
	header("location: ../edit-user.php?id=$id&info=Hai, sepertinya ada yang salah nih, mohon ulangi kembali.");
}
