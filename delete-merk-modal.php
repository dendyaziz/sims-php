...
<form method="POST" action="">	
		...
		<div class="row">
			<div class="col-md-12">
				<div class="form-group">
					...
					<input type="text" class="form-control" id="group2" name="group2" value="<?php if(!empty($group2)){echo $group2;}?>" readonly required="required">
				</div>
			</div>
		</div>
	...
	<div class="modal-footer">
		<button type="submit" class="btn btn-danger btn-sm" formaction="fc/fc_delete_group2_modal.php"><i class="fa fa-refresh"></i> Delete</button>
