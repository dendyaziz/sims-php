...
<head>
    ...
    <title>Destruction Transaction :: <?php echo $app_name;?></title>
		...
		<div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h3 class="text-themecolor">Destruction Transaction</h3>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                            <li class="breadcrumb-item active">Destruction Transaction</li>
                        </ol>
                    </div>
					<!--
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card card-body">
                            <h4 class="card-title">Input Destruction Transaction</h4>
                            <h5 class="card-subtitle"> Destruction <code>Transaction</code> </h5>
                            <div class="row">
                                <div class="col-sm-12 col-xs-12">
                                    ...
                                    <form method="POST" action="">										
										...
										<div class="row">
											...
											<div class="col-md-12">
												<button type="submit" class="btn btn-success mr-2" formaction="fc/fc_add_destroy.php" id="btn_save"><i class="fa fa-paper-plane"></i> Submit</button>
								...
								<div class="table-responsive">									
									<table class="table table-sm table-striped table-hover table-bordered" id="data-table">
										...
										<tbody>
											...
											$sql="Select * from PEMUSNAHAN where branch='$Qbranch' and tanggal='$tanggal' and faktur='$faktur' order By id";
													...
													echo"
														<tr>
															...
															<td align='center' nowrap>
																<a class='btn btn-danger btn-sm' href='fc/fc_delete_destroy.php?id=$id2&tanggal=$tanggal2&faktur=$faktur'><i class='fa fa-trash'></i> Delete</a>
															</td>
														</tr>
													";
												}												
