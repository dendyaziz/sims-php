...
<head>
	...
	function cek_stok(){
		...
		var a=document.getElementById('sesuai_panjang').value;
		var b=document.getElementById('sesuai_lebar').value;
		...
		<div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h3 class="text-themecolor">Penyesuaian Stok</h3>
                        <ol class="breadcrumb">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card card-body">
                            <h4 class="card-title">Penyesuaian Stok Barang</h4>
                            <h5 class="card-subtitle"> Adjustment <code>Stock</code> </h5>
                            <div class="row">
										...
										<div class="row">
											<div class="col-md-3">
												<div class="form-group">
													...
													<input class="form-control form-control-line" type="date" name="tanggal" id="tanggal" value="<?php if(!empty($_POST['tanggal'])){echo date('Y-m-d',strtotime($_POST['tanggal']));}else{if(!empty($_GET['tanggal'])){echo date('Y-m-d',strtotime($_GET['tanggal']));}else{echo date("Y-m-d");}}?>" <?php if(!empty($_SESSION["iss21"]["faktur"])){echo "readonly";}?> readonly required="required">
												</div>
											</div>
											<div class="col-md-3">
												<div class="form-group">
											...
											<div class="col-md-6">
												<div class="form-group">
													<label for="alasan">Alasan Penyesuaian Stok</label>
													<input type="text" class="form-control" id="alasan" name="alasan" value="<?php if(!empty($_POST['alasan'])){echo $_POST['alasan'];}else{if(!empty($_GET['alasan'])){echo $_GET['alasan'];}}?>" <?php if(!empty($_SESSION["iss21"]["faktur"])){echo "readonly";}?> required="required" <?php if(empty($_POST['alasan'])){echo "autofocus";} ?>>
												</div>
											</div>
										</div>							
										<div class="row">
										...
										<div class="row">
											<div class="col-md-3">
												<div class="form-group">
													...
													<select class="custom-select col-12" id="penyesuaian" name="penyesuaian" required="required" <?php if(empty($_POST['penyesuaian'])){echo "autofocus";}?>>
														<option value="<?php if(!empty($_POST['penyesuaian'])){echo $_POST['penyesuaian'];}?>"><?php if(!empty($_POST['penyesuaian'])){echo $_POST['penyesuaian'];}else{echo "Pilih...";}?></option>
											...
											<div class="col-md-3">
												<div class="row">
													<div class="col-md-6">	
														<div class="form-group">
															<label for="sesuai_panjang">Panjang</label>
															<input type="text" class="form-control" id="sesuai_panjang" name="sesuai_panjang" oninput="javascript:cek_stok();" onKeyPress="return filter_char(event,'0123456789.',this)" required="required" autofocus>
															<?php 
																if($jenis=="Cleated" or $jenis=="Profile"){
													...
													<div class="col-md-6">
														<div class="form-group">
															<label for="sesuai_lebar">Lebar</label>
															<input type="text" class="form-control" id="sesuai_lebar" name="sesuai_lebar" onKeyPress="return filter_char(event,'0123456789.',this)" value="<?php if($jenis=="Cleated" or $jenis=="Profile"){if(!empty($lebar)){echo ($lebar/100);}}?>" <?php if($jenis=="Cleated" or $jenis=="Profile"){ echo "readonly";}?> oninput="javascript:cek_stok();" required="required" autofocus>
															<?php 
																if($jenis=="Cleated" or $jenis=="Profile"){
																	echo"<small>input dalam meter (M)</small>";
																}else{
											...
											<div class="col-md-6">										
												<div class="form-group">
													<label for="jumlah">Ukuran Barang Penyesuaian</label>
											...
											<div class="col-md-12">										
												<div class="form-group">
													<button type='submit' class='btn btn-success mr-2' id="btn_save" formaction="fc/fc_add_penyesuaian.php">Submit</button>
							...
							<div class="table-responsive">									
								<table class="table table-bordered" id="table">
									...
									<tbody>
										...
										$total1=0;
										$total2=0;
										$result = $con->query("Select * from PENYESUAIAN where DATE(tanggal) = '$tgl' and faktur='$faktur' order By entrydate");
										$count = mysqli_num_rows($result);
										if($count>0){
											while($row = mysqli_fetch_assoc($result))
											{
