		...
		<div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h3 class="text-themecolor">Registrasi User</h3>
                        <ol class="breadcrumb">
													...
													echo"
														<tr>
															...
															<td align='center' nowrap>
																...
																echo" title='Delete' data-toggle='modal' data-toggle='modal' data-target='#deleteModal' data-id=".$id." data-whatever='@getbootstrap'><i class='fa fa-trash'></i> Delete</button>
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-footer">
					<button type="submit" class="btn btn-success btn-sm" formaction="fc/fc_add_user_modal.php"><i class="fa fa-paper-plane"></i> Submit</button>
