...
<form method="POST" action="">	
		...
		<div class="row">
			...
			<div class="col-md-6">
				<div class="form-group">
					...
					<input type="text" class="form-control" id="dept" name="dept" value="<?php if(!empty($dept)){echo $dept;}?>" required="required">
				</div>
			</div>
			...
			<div class="col-md-12">
				<div class="form-group">
					...
					<input type="text" class="form-control" id="position" name="position" value="<?php if(!empty($position)){echo $position;}?>" required="required">
				</div>
			</div>
			<div class="col-md-12">
				<div class="form-group">
	...
	<div class="modal-footer">
		<button type="submit" class="btn btn-primary btn-sm" formaction="fc/fc_edit_karyawan_modal.php"><i class="fa fa-refresh"></i> Update</button>
