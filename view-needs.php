...
<head>
    ...
    <title>View Needs :: <?php echo $app_name;?></title>
                        ...
                        <div class="card card-body">
							<div class="col-sm-12 col-xs-12">
								...
								<div class="table-responsive" id="cetak">
									...
									<h4 class="card-title"><b>PENDATAAN KEBUTUHAN</b>
									...
									<table class="table table-sm table-hover table-bordered" id="table">
										...
										<tbody>
											...
											$Quser=$username;
											$sql="Select * from KEBUTUHAN where branch='$Qbranch' and username='$Quser' and CONVERT(tanggal, DATE)='$tanggal' order By branch, CONVERT(tanggal, DATE), jenis, barang, kode, satuan";
