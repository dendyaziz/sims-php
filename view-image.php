	...
	if($count>0){
		while($row = mysqli_fetch_assoc($result))
		{
			...
			if(empty($gambar2)){
				...
				$url2="<img src='barang/$profile_picture2' width='100' height='auto' style='border:1px solid #999;' data-toggle='modal' data-toggle='modal' data-target='#popupImages' data-whatever='@getbootstrap' />";
