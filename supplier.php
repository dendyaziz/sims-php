		...
		<div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h3 class="text-themecolor">Master Suplier</h3>
                        <ol class="breadcrumb">
                            ...
                            <div class="card-body">
								<div class="row">									
									<div class="col-md-5 align-self-center">
										...
										<h6 class="card-subtitle">Supplier <code>List</code></h6>
									</div>
                                ...
                                <div class="table-responsive">									
                                    <table class="table table-sm table-striped table-hover table-bordered" id="data-table">
                                        ...
                                        <tbody>
											<?php
											$no=0;
											$result = $con->query("Select * from SUPPLIER order By kode,supplier");
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-footer">
					<button type="submit" class="btn btn-success btn-sm" formaction="fc/fc_add_supplier_modal.php"><i class="fa fa-paper-plane"></i> Submit</button>
