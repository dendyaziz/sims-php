...
<head>
    ...
    <title>Merk :: <?php echo $app_name;?></title>
	<style>
		@media screen {			
			div.divHeader{
				display: none;
		...
		<div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h3 class="text-themecolor">Merk</h3>
                        <ol class="breadcrumb">
                    ...
                    <div class="col-12">
                        <div class="card">							
                            <div class="card-body">
								<div class="row">									
									<div class="col-md-5 align-self-center">
										<h4 class="card-title">Daftar Semua Merk</h4>
										<h6 class="card-subtitle">Merk <code>List</code></h6>
									</div>
                                ...
                                <div class="table-responsive">									
                                    <table class="table table-sm table-striped table-hover table-bordered" id="data-table">
                                        ...
                                        <tbody>
											<?php
											$no=0;
											$result = $con->query("Select * from MERK order By merk");
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h4 class="modal-title" id="addModalLabel">Add Merk</h4>
				...
				<div class="modal-footer">
					<button type="submit" class="btn btn-success btn-sm" formaction="fc/fc_add_merk_modal.php"><i class="fa fa-paper-plane"></i> Submit</button>
