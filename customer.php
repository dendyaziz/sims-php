		...
		<div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h3 class="text-themecolor">Master Customer</h3>
                        <ol class="breadcrumb">
                    ...
                    <div class="col-12">
                        <div class="card">							
                            <div class="card-body">
								<div class="row">									
									<div class="col-md-5 align-self-center">
										<h4 class="card-title">Daftar Semua Customer</h4>
										<h6 class="card-subtitle">Customer <code>List</code></h6>
									</div>
                                ...
                                <div class="table-responsive">									
                                    <table class="table table-sm table-striped table-hover table-bordered" id="data-table">
                                        ...
                                        <tbody>
											<?php
											$no=0;
											$result = $con->query("Select * from CUSTOMER order By kode,customer");
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<div class="form-group">
						...
						<input type="text" class="form-control" id="customer" name="customer" required="required">
					</div>
					<div class="form-group">
				...
				<div class="modal-footer">
					<button type="submit" class="btn btn-success btn-sm" formaction="fc/fc_add_customer_modal.php"><i class="fa fa-paper-plane"></i> Submit</button>
