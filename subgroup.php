...
<head>
    ...
    <title>Sub Group :: <?php echo $app_name;?></title>
	<style>
		@media screen {			
			div.divHeader{
				display: none;
		...
		<div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h3 class="text-themecolor">Sub Group</h3>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                            <li class="breadcrumb-item active">Sub Group</li>
                        </ol>
                    </div>										
                </div>
                <div class="row">
                    ...
                    <div class="col-12">
                        <div class="card">							
                            <div class="card-body">
								<div class="row">									
									<div class="col-md-5 align-self-center">
										<h4 class="card-title">Daftar Semua Sub Group</h4>
										<h6 class="card-subtitle">Sub Group <code>List</code></h6>
									</div>
                                ...
                                <div class="table-responsive">									
                                    <table class="table table-sm table-striped table-hover table-bordered" id="data-table">
                                        ...
                                        <tbody>
											<?php
											$no=0;
											$result = $con->query("Select * from SUBGROUP order By subgroup");
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h4 class="modal-title" id="addModalLabel">Add Sub Group</h4>
					...
					<div class="row">						
						<div class="col-md-12">
							<div class="form-group">
								...
								<input type="text" class="form-control" id="subgroup" name="subgroup" required="required">
							</div>
						</div>						
					</div>
				...
				<div class="modal-footer">
					<button type="submit" class="btn btn-success btn-sm" formaction="fc/fc_add_subgroup_modal.php"><i class="fa fa-paper-plane"></i> Submit</button>
