...
<head>
    ...
    <title>Add PO :: <?php echo $app_name;?></title>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card card-body">
                            ...
                            <h5 class="card-subtitle"> Purchase Order<code>Registration</code> </h5>
                            <div class="row">
												...
												<div class="row">
													...
													<div class="col-md-12">
														<div class="form-group">
															...
															<small>Isi dengan sebagian nama suplier dan pilih</small>
														</div>
													</div>
												</div>
												<div class="row">
												...
												<div class="row">										
													...
													<div class="col-md-4">
														<div class="form-group">
															...
															<input class="form-control form-control-line" type="text" name="tipe" id="tipe" value="<?php echo $tipe; ?>" <?php if(empty($tipe)){echo "autofocus";} ?> onchange="document.getElementById('qty').focus();" required="required">
														</div>
													</div>
													<div class="col-md-4">
														<div class="form-group">
												    ...
												    <div class="col-md-12">
														<div class="form-group">
															...
															<input class="form-control form-control-line" type="text" name="descr" id="descr" value="<?php echo $descr; ?>" required="required">
														</div>
													</div>
													<div class="col-md-12">
