...
<head>
    ...
    <title>View Opname :: <?php echo $app_name;?></title>
		...
		<div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h3 class="text-themecolor">Lihat Data Stock Opname</h3>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                            <li class="breadcrumb-item active">Lihat Data Stock Opname</li>
                        </ol>
                    </div>										
                </div>
                <div class="row">
                    <div class="col-12">
                        <div class="card card-body">
                            <h4 class="card-title">Lihat Data Stock Opname</h4>
                            <h5 class="card-subtitle"> View <code>Opname</code> </h5>
                            <div class="row">
                        ...
                        <div class="card card-body">
							<div class="col-sm-12 col-xs-12">
								...
								<div class="table-responsive" id="cetak">	
									<h4 class="card-title Sembunyikan"><b>STOCK OPNAME</b>
										<br>Tanggal <?php echo date('d/m/Y',strtotime($_GET['tanggal'])); ?>
										<br>Oleh <?php echo $username; ?>
